...
\begin{abstract}
We study the formal verification of optimized computations arising in the
...
fundamental parallelepiped.  The production code uses substantial
...
goal is not to formalize the whole theory of the unitary dual, nor the whole
\atlas{} C++ implementation, but instead to prove that the optimized script-level
computation is functionally equivalent to the slow reference algorithm, modulo
