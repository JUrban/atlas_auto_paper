...
We replace\footnote{\url{https://github.com/JUrban/atlasofliegroups_sml1/tree/to_ht_branch_alt}} (in almost automated Codex sessions) \texttt{.at} execution by \sml programs using \polyml{} \cite{PolyML}.  A small C
...
be stated, generated, reviewed, and ultimately proved. The Codex coding was supervised by us and unit testing based on the F4 and other computed results.
