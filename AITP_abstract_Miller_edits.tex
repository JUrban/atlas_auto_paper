...
We replace\footnote{\url{https://github.com/JUrban/atlasofliegroups_sml1/tree/to_ht_branch_alt}} (in almost automated Codex sessions) \axis{} (\texttt{.at}) scripts by \sml programs using \polyml{} \cite{PolyML}.  A small C
ABI shim exposes a curated subset of the \atlas{} C++ API as a shared library,
which is then bound in \sml using the \polyml foreign-function interface.\footnote{\url{https://github.com/JUrban/atlasofliegroups_sml1/blob/to_ht_branch_alt/atlas-scripts-sml/ffi}}  The
...
\texttt{script\_to\_verify\_F4\_FPP\_unitary\_dual.at}.\footnote{\url{https://github.com/JUrban/atlasofliegroups_sml1/blob/to_ht_branch_alt/atlas-scripts/script_to_verify_F4_FPP_unitary_dual.at}}  It checks a finite set
...
\texttt{script\_to\_verify\_F4\_FPP\_unitary\_dual.sml}\footnote{\url{https://github.com/JUrban/atlasofliegroups_sml1/blob/to_ht_branch_alt/atlas-scripts-sml/script_to_verify_F4_FPP_unitary_dual.sml}} runs a fast pipeline
...
The corresponding slow program, \texttt{SimplerVerifyF4FPP.sml},\footnote{\url{https://github.com/JUrban/atlasofliegroups_sml1/blob/to_ht_branch_alt/atlas-scripts-sml/SimplerVerifyF4FPP.sml}} is a direct
translation of a brute-force checker\footnote{\url{https://github.com/JUrban/atlasofliegroups_sml1/blob/to_ht_branch_alt/atlas-scripts/simpler_script_to_verify_F4_FPP_unitary_dual.at}} that ranges over a large triple domain of
